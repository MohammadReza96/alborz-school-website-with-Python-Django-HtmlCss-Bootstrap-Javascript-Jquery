    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blog_is_active",
                    models.BooleanField(default=False, verbose_name="وضعیت مقاله"),
                ),
                (
                    "blog_view_number",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="blog_comments_like",
                        to="blog.blog",
                        verbose_name="کالا",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="main_user_blog_like",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="کاربر",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "register_date",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="تاریخ درج نظر"
                    ),
                ),
                (
                    "is_active",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="extra_user_blog_comment",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="ادمین تایید کننده",
                    ),
                ),
            ],
            options={
