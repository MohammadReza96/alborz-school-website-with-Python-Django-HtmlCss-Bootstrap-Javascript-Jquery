...
class BlogsView(View):
    def get(self,request,*args,**kwargs):
        ...
        # distict method does not work properly in sqlit data base so I mix it with value method to slove this issue
        blog_tags=Tag.objects.filter().values('tag_name').distinct()  

        pagienator=Paginator(blogs,4) 
